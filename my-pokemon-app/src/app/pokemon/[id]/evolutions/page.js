...
const renderEvolutions = (chain, mainType) => {
  ...
  return (
    <div
      ...
      className={`${backgroundColor} bg-opacity-35 rounded-lg shadow-lg p-10 flex flex-col items-center text-gray-300 transition-transform duration-200 hover:scale-105 m-8`}
    >
